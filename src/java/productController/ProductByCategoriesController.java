 ...
 * @author ASUS
 */
@WebServlet(name = "ProductByCategoriesController", urlPatterns = {"/productCate"})
public class ProductByCategoriesController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      ProductsJpaController dao = new ProductsJpaController();
        ...
        if (cate == null) {
            list = dao.findNewestProducts();
        } else {
            list = dao.findByCategory(Integer.parseInt(cate));
        }
